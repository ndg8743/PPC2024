...
CREATE TABLE `student_registrations` (
  ...
  CONSTRAINT `student_registrations_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`),
  CONSTRAINT `student_registrations_ibfk_2` FOREIGN KEY (`offering_id`) REFERENCES `lecture_offerings` (`offering_id`)
...
INSERT INTO `student_registrations` VALUES (1,1,1),(2,2,2),(3,3,3);
